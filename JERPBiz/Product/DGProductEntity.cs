...
namespace JERPBiz.Product
{
    ...
    /// 2016-08-31 18:28:14
    ///</时间>  
    public class DGProductEntity
    {
        public DGProductEntity()
        {
            this.accData = new JERPData.Product.ComProduct();
        }
        private JERPData.Product.ComProduct accData;
        public int PrdID = -1;
        ...
        public int UnitID = -1;
        public int DPType = -1;
        public decimal JMPrice = 0;
        public decimal PFPrice = 0;
        public decimal HYPrice = 0;
        public decimal LSPrice = 0;
        ...
        public void LoadData(int PrdID)
        {
            ...
            if (drow["DPType"] == DBNull.Value)
            {
                this.DPType = -1;
            }
            else
            {
                this.DPType = (int)drow["DPType"];
            }
            if (drow["JMPrice"] == DBNull.Value)
            {
                this.JMPrice = 0;
            }
            else
            {
                this.JMPrice = (decimal)drow["JMPrice"];
            }
            if (drow["PFPrice"] == DBNull.Value)
            {
                this.PFPrice = 0;
            }
            else
            {
                this.PFPrice = (decimal)drow["PFPrice"];
            }
            if (drow["HYPrice"] == DBNull.Value)
            {
                this.HYPrice = 0;
            }
            else
            {
                this.HYPrice = (decimal)drow["HYPrice"];
            }
            if (drow["LSPrice"] == DBNull.Value)
            {
                this.LSPrice = 0;
            }
            else
            {
                this.LSPrice = (decimal)drow["LSPrice"];
            }
            if (drow["CustomCode"] == DBNull.Value)
            {
                this.CustomCode = string.Empty;
            }
            else
            {
                this.CustomCode = drow["CustomCode"].ToString();
            }
            if (drow["Brand"] == DBNull.Value)
            {
                this.Brand = string.Empty;
            }
            else
            {
                this.Brand = drow["Brand"].ToString();
            }
            ...
            if (drow["CustomFlag"] == DBNull.Value)
            {
                this.CustomFlag = false;
            }
            else
            {
                this.CustomFlag = (bool)drow["CustomFlag"];
            }
